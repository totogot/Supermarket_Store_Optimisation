...
Now Docker is up and running, the next stage is th download and compile the OSRM. The fgollowing instructions adapted from the official documentation here: https://github.com/Project-OSRM/osrm-backend
